...
public class Board extends JPanel implements GameConstants, PlayerConstants {
	...
	private void loadPower() {
		ryuPower = new Power(30, "Ryu".toUpperCase());
		kenPower = new Power(GWIDTH - 360, "Ken".toUpperCase());
	}
	...
	private void printMessage(Graphics pen) {
		...
		pen.setFont(new Font("Monospaced",Font.BOLD, 70));
		pen.drawString("Game Over", 430, GHEIGHT/2-120);
	}
